...
public class AtendimentoExcluido implements Serializable {
	...
	public Time getHoraexclusao() {
		return horaexclusao;
	}

	public void setHoraexclusao(Time horaexclusao) {
		this.horaexclusao = horaexclusao;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AtendimentoExcluido other = (AtendimentoExcluido) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "AtendimentoExcluido [id=" + id + ", nome=" + nome + ", hospital=" + hospital + ", medico=" + medico
				...
				+ ", login=" + login + ", cpf=" + cpf + ", dataexclusao=" + dataexclusao + ", horaexclusao="
				+ horaexclusao + "]";
	}
