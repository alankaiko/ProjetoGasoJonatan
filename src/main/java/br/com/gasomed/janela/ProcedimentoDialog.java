...
import br.com.gasomed.listener.ProcedimentoListener;
import br.com.gasomed.util.CampoMaiusculoUtil;

public class ProcedimentoDialog extends JDialog {
	...
	private ProcedimentoListener listener;

	public ProcedimentoDialog() {
		this.MontarDados();
		this.MontarComponentes();
		
		this.listener = new ProcedimentoListener(this);
	}
